...
**Implementation:** The reproducible self-contained win-x64 publisher and public one-line install/update bootstrap are implemented. Public prereleases `v0.4.0-pilot.1` and `v0.4.0-pilot.2` are published with verified package/checksum assets. Real two-computer evidence remains.
